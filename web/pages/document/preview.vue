...
.status-accordion-item.expanded {
...
.docx-preview-shell .overlay,
.docx-preview-shell .modal-error {
  position: absolute;
  inset: 0;
  display: flex;
  align-items: center;
...
.docx-preview-container :deep(.docx:not([data-page-label])::after) {
  content: none;
}
