...
function exportWorkspace() {
  const payload = exportDocumentWorkspace()
...
function handleImport(event: Event) {
  ...
  reader.onload = (e) => {
    try {
      ...
      workspaceState.value = importDocumentWorkspace(parsed)
...
function clearWorkspace() {
  workspaceState.value = clearDocumentWorkspace()
...
<style scoped src="./DocumentStorage.css"></style>
